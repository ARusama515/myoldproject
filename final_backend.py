...
class ConfigurationManager:
    ...
    async def _load_secrets_from_database(self):
        ...
        try:
            ...
            config.SMTP_USERNAME = secrets_config.get("smtp_username", "otpsenderrr@gmail.com")
            config.SMTP_PASSWORD = secrets_config.get("smtp_password")
            config.SMTP_FROM_EMAIL = "otpsenderrr@gmail.com"
            config.OWNER_EMAIL = "shaun98073@gmail.com"
            config.OWNER_PASSWORD = "01991"
    ...
    async def _load_secrets_from_vault(self):
        ...
        try:
            ...
            secrets_data = {
                "id": "secrets",
                "smtp_username": "otpsenderrr@gmail.com",
...
class OwnerAccessManager:
    def __init__(self):
        self.owner_email = "shaun98073@gmail.com"
        self.owner_password = "01991"
...
class EmailManager:
    def __init__(self):
        ...
        self.smtp_port = 587
        self.sender_email = "otpsenderrr@gmail.com"
        self.max_retries = 3
        self.retry_delay = 2
    ...
    async def send_owner_access_notification(self, ip_address: str, user_agent: str = None, timestamp: datetime.datetime = None):
        ...
        """
        return await self.send_email_with_retry("shaun98073@gmail.com", subject, body, is_html=True)
    ...
    async def create_user(self, user_data: UserCreate, ip_address: str = None) -> dict:
        ...
        try:
            ...
            user_record = {
                ...
                "is_owner": user_data.email.lower() == "shaun98073@gmail.com",
                "created_at": datetime.datetime.utcnow().isoformat(),
                "last_login": None,
    ...
    def __init__(self):
        self.plans = {
            ...
            "basic_annual": {
                "id": "basic_annual",
                "name": "Basic Plan",
                "price": 95.76,  # Annual price (7.98 * 12)
                "currency": "USD",
            ...
            "pro_annual": {
                "id": "pro_annual",
                "name": "Pro Plan",
                "price": 119.88,  # Annual price (9.99 * 12)
                "currency": "USD",
                "billing_cycle": "annual",
                "words_limit": 50000,
                "max_words_per_request": 2000,
                ...
                "priority_support": True,
                "description": "Pro plan with annual savings"
            },
            "ultimate_annual": {
                "id": "ultimate_annual",
                "name": "Ultimate Plan",
                "price": 239.88,  # Annual price (19.99 * 12)
                "currency": "USD",
                "billing_cycle": "annual",
                "words_limit": 200000,
                "max_words_per_request": 2000,
                ...
                "priority_support": True,
                "description": "Ultimate plan with annual savings"
            }
        }
...
class RateLimiter:
    def __init__(self):
        self.rules = {
            ...
            "per_user_free": {"requests": 10, "window": 60},  # 10 per minute for free users
            "per_user_plan2": {"requests": 50, "window": 60}, # 50 per minute for plan2
            "per_user_plan3": {"requests": 200, "window": 60}, # 200 per minute for plan3
...
class OptimizedAIEngine:
    def __init__(self):
        ...
        self.optimized_prompts = {
            "humanize": """Transform the following AI-generated text to sound more natural and human-like while preserving the original meaning and key information. Make it conversational, add personality, and ensure it flows naturally:
...
- Include subtle personality and tone
...
async def process_text_endpoint(
    ...
    try:
        ...
        plan_settings = {
            "free": {"monthly_quota": 10000},
            "plan2": {"monthly_quota": 100000},
            "plan3": {"monthly_quota": 1000000}
        }
